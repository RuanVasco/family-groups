    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/asset/**").hasRole("TECHNICIAN")
                        .requestMatchers(HttpMethod.PUT, "/asset/**").hasRole("TECHNICIAN")
                        .requestMatchers(HttpMethod.GET, "/asset/**").hasRole("TECHNICIAN")
